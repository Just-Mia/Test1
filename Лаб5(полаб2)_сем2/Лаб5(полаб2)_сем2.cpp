// Лаб5(полаб2)_сем2.cpp : This file contains the 'main' function. Program execution begins and ends there.
//
#include <iostream>
 #include <string>
using namespace std;
...
private:
 ...
 public:
    ...
    Video(const Video& other) : Media(other), likes(other.likes) {
     ...
     virtual ~Video() { cout << "Deleting video: " << title << endl; }
...
class Movie final : public Video {
private:
    string director;
 public:
    ...
    void play() const override {
        cout << "Playing movie directed by " << director << endl;
    }
};
...
public:
    ...
    void play() const override {
        cout << "Streaming from channel: " << channelName << endl;
    }
};
...
class Audio : public MediaInterface {
private:
    string songName;
public:
     Audio(string name) : songName(name) {}
    void render() const override {
        cout << "Playing audio: " << songName << endl;
    }
};
